...
var _opts = {
    autojoin   : true,
    memberaddr : 'tcp://'+address()+':'+11000,
    pubaddr    : 'inproc://yolog'
}

var yolog = function(log, opts) {
    if (!(this instanceof yolog)) return new yolog(log, opts)
    this.opts = assign(_opts, opts || {}, { log:log }) 
    this.state = {
        stores       : [],
        projectors   : [],
        livestreams  : [],
        swarm        : null,
        connections  : {
            pubs : [nano.socket('pub')],
            subs : []
        }
    }
    this.pub = this.state.connections.pubs[0]
}
util.inherits(yolog, stream.Duplex)
//yolog.prototype._write = function(chunk, encoding, done) {
//    // TODO: pub.send ?
//    console.log('write', chunk.toString())
//    this.state.stores.concat(this.state.livestreams).forEach(function(stream) {
//        
//    })
//    done()
//}
//yolog.prototype._read = function(n) {
//    // TODO: sub.onMessage ?
//    setTimeout(function() {
//        this.push('some data\n')
//        this.pause()
